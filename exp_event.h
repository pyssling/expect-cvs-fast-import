...
int exp_get_next_event _ANSI_ARGS_((Tcl_Interp *,ExpState **, int, Exp_State **, int, int));
int exp_get_next_event_info _ANSI_ARGS_((Tcl_Interp *, ExpState *, int));
...
void exp_event_disarm _ANSI_ARGS_((ExpState *));
...
void exp_background_channelhandler _ANSI_ARGS_((ClientData,ExpState *));
